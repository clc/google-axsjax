...
axsScholar.extraKeyboardNavHandler = function(evt){
  ...
  if (evt.charCode == 63){ // ? (question mark)
    axsScholar.axsJAXObj.speakTextViaNode(axsScholar.HELP_STRING);
    return false;
  }
  ...
  if (evt.keyCode == 13){ // Enter
    if (axsScholar.currentResult.mainLink){
      ...
      axsScholar.axsJAXObj.speakTextViaNode(axsScholar.NO_MAIN_LINK_STRING);
    }
    return false;
  }
  ...
  if ((evt.charCode == 118) || (evt.charCode == 86)){ // v
    if (axsScholar.currentResult.versionsLink){
      ...
      axsScholar.axsJAXObj.speakTextViaNode(axsScholar.ONLY_ONE_VERSION_STRING);
    }
    return false;
  }
  ...
  if ((evt.charCode == 99) || (evt.charCode == 67)){ // c
    if (axsScholar.currentResult.citationLink){
      ...
      axsScholar.axsJAXObj.speakTextViaNode(axsScholar.CITED_BY_STRING + axsScholar.UNAVAILABLE_STRING);
    }
    return false;
  }
  ...
  if ((evt.charCode == 114) || (evt.charCode == 82)){ // r
    if (axsScholar.currentResult.relatedArticlesLink){
      ...
      axsScholar.axsJAXObj.speakTextViaNode(axsScholar.RELATED_ARTICLES_STRING + axsScholar.UNAVAILABLE_STRING);
    }
    return false;
  }
  ...
  if ((evt.charCode == 119) || (evt.charCode == 87)){ // w
    if (axsScholar.currentResult.webSearchLink){
      ...
      axsScholar.axsJAXObj.speakTextViaNode(axsScholar.WEB_SEARCH_STRING + axsScholar.UNAVAILABLE_STRING);
    }
    return false;
  }
  ...
  if ((evt.charCode == 108) || (evt.charCode == 76)){ // l
    if (axsScholar.currentResult.librarySearchLink){
      ...
      axsScholar.axsJAXObj.speakTextViaNode(axsScholar.LIBRARY_SEARCH_STRING + axsScholar.UNAVAILABLE_STRING);
    }
    return false;
  }
  ...
  if ((evt.charCode == 104) || (evt.charCode == 72)){ // h
    if (axsScholar.currentResult.HTMLVerLink){
      ...
      axsScholar.axsJAXObj.speakTextViaNode(axsScholar.VIEW_AS_HTML_STRING + axsScholar.UNAVAILABLE_STRING);
    }
    return false;
  }
  ...
  if ((evt.charCode == 105) || (evt.charCode == 73)){ // i
    if (axsScholar.currentResult.importLink){
      ...
      axsScholar.axsJAXObj.speakTextViaNode(axsScholar.IMPORT_INTO_STRING + axsScholar.UNAVAILABLE_STRING);
    }
    return false;
  }
  ...
  if ((evt.charCode == 98) || (evt.charCode == 66)){ // b
    if (axsScholar.currentResult.BLDirectLink){
      ...
      axsScholar.axsJAXObj.speakTextViaNode(axsScholar.BL_DIRECT_STRING + axsScholar.UNAVAILABLE_STRING);
    }
    return false;
  }
  return true;
...
axsScholar.announceOptions = function(){
  ...
  axsScholar.axsJAXObj.speakTextViaNode(messageString);
};
