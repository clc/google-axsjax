 ...
 *
 * Example URL: http://washingtondc.craigslist.org/forums/
 *
 ...
 */
axsCraigsList.str = {
  ENTER_TOPIC : 'Please select a topic'
};
...
axsCraigsList.CNR = '<cnr next="RIGHT l" prev="LEFT h">' +
    ...
    '<list title="Forums" next="DOWN j" prev="UP k" fwd="n" back="p">' +

      '<item>' +
        '//span/a' +
      '</item>'+

      '<target title="Open the forum link" hotkey="ENTER">' +
        '.' +
      '</target>' +
...
axsCraigsList.init = function() {
  ...
  var completionPromptStr = axsCraigsList.str.ENTER_TOPIC;
...
axsCraigsList.charCodeMap = {
  ...
  // / (slash symbol)
  47 : function() {
         document.getElementsByName('SQ')[0].focus();
         document.getElementsByName('SQ')[0].select();
         return false;
       },  
  // - (minus symbol)
  45 : function() {
