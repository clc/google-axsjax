...
function checkDomain(oLink,useDebug) {
  ...
  if ((!document.domain || !window.location.protocol.match(/http/i)) && o.indexOf('index.html')==-1) oLink.href=(useDebug?o.substr(0,o.lastIndexOf('#')):o)+'index.html'+(useDebug?'#debug=1':'');
}
